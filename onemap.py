...
class OneMapClient():
    ...
    def query_api(self, endpoint, param_dict):
        ...
        try:
            ...
            return json.loads(request.get(self.url_base + endpoint,
    ...
    def search(self, search_val, return_geom=True, get_addr_details=True, page_num=1):
        ...
        try:
            ...
            return json.loads(request.get(self.url_base + "/commonapi/search",
    ...
    def reverse_geocode_SVY21(self, coordinates, buffer=10, address_type="All", other_features=False):
        ...
        try:
            ...
            return json.loads(request.get(self.url_base + "/privateapi/commonsvc/revgeocodexy",
    ...
    def reverse_geocode_WGS84(self, coordinates, buffer=10, address_type="All", other_features=False):
        ...
        try:
            ...
            return json.loads(request.get(self.url_base + "/privateapi/commonsvc/revgeocode",
                                           params={'location': location,
                                                   'token': self.token,
                                                   'buffer': buffer,
                                                   'addressType': address_type,
    ...
    def WGS84_to_EPSG(self, coordinates):
        try:
            return json.loads(request.get(self.url_base + "/commonapi/convert/4326to3857",
    ...
    def WGS84_to_SVY21(self, coordinates):
        try:
            return json.loads(request.get(self.url_base + "/commonapi/convert/4326to3414",
                                           params={'latitude': coordinates[0],
                                                   'longitude': coordinates[1]}).text)
        except Exception as e:
            print(e)
    ...
    def SVY21_to_EPSG(self, coordinates):
        try:
            return json.loads(request.get(self.url_base + "/commonapi/convert/3414to3857",
    ...
    def SVY21_to_WGS84(self, coordinates):
        try:
            return json.loads(request.get(self.url_base + "/commonapi/convert/3414to4326",
                                           params={'X': coordinates[0],
                                                   'Y': coordinates[1]}).text)
        except Exception as e:
            print(e)
    ...
    def EPSG_to_SVY21(self, coordinates):
        try:
            return json.loads(request.get(self.url_base + "/commonapi/convert/3857to3414",
                                           params={'X': coordinates[0],
                                                   'Y': coordinates[1]}).text)
        except Exception as e:
            print(e)
    ...
    def EPSG_to_WGS84(self, coordinates):
        try:
            return json.loads(request.get(self.url_base + "/commonapi/convert/3857to4326",
                                           params={'X': coordinates[0],
                                                   'Y': coordinates[1]}).text)
        except Exception as e:
            print(e)
    ...
    def check_theme_status(self, query_name, date_time):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/themesvc/checkThemeStatus",
    ...
    def get_theme_info(self, query_name):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/themesvc/getThemeInfo",
                                           params={'queryName': query_name,
    ...
    def get_all_themes_info(self, more_info=False):
        ...
        try:
            ...
            return json.loads(request.get(self.url_base + "/privateapi/themesvc/getAllThemesInfo",
    ...
    def retrieve_theme(self, query_name, extents=None):
        ...
        try:
            ...
            return json.loads(request.get(self.url_base + "/privateapi/themesvc/retrieveTheme",
                                           params={'queryName': query_name,
                                                   'extents': extents,
                                                   'token': self.token}).text)
        except Exception as e:
    ...
    def get_all_planning_areas(self, year=None):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getAllPlanningarea",
                                           params={'year': year,
                                                   'token': self.token}).text)
        except Exception as e:
            print(e)
    ...
    def get_planning_area_names(self, year=None):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getPlanningareaNames",
                                           params={'year': year,
                                                   'token': self.token}).text)
        except Exception as e:
            print(e)
    ...
    def get_planning_area_bounds(self, coordinates, year=None):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getPlanningarea",
                                           params={'year': year,
                                                   'lat': coordinates[0],
                                                   'long': coordinates[1],
                                                   'token': self.token}).text)
    ...
    def get_economic_statuses(self, year, planning_area, gender=None):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getEconomicStatus",
                                           params={'year': year,
    ...
    def get_education_attendance(self, year, planning_area):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getEthnicGroup",
                                           params={'year': year,
                                                   'planningArea': planning_area,
                                                   'token': self.token}).text)
        except Exception as e:
    ...
    def get_household_monthly_work_income(self, year, planning_area):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getHouseholdMonthlyIncomeWork",
                                           params={'year': year,
                                                   'planningArea': planning_area,
                                                   'token': self.token}).text)
        except Exception as e:
    ...
    def get_household_sizes(self, year, planning_area):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getHouseholdSize",
                                           params={'year': year,
                                                   'planningArea': planning_area,
                                                   'token': self.token}).text)
        except Exception as e:
    ...
    def get_household_structures(self, year, planning_area):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getHouseholdStructure",
                                           params={'year': year,
                                                   'planningArea': planning_area,
                                                   'token': self.token}).text)
        except Exception as e:
    ...
    def get_work_income(self, year, planning_area):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getIncomeFromWork",
                                           params={'year': year,
                                                   'planningArea': planning_area,
                                                   'token': self.token}).text)
        except Exception as e:
    ...
    def get_industries(self, year, planning_area):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getIndustry",
                                           params={'year': year,
                                                   'planningArea': planning_area,
                                                   'token': self.token}).text)
        except Exception as e:
    ...
    def get_language_literacy(self, year, planning_area):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getLanguageLiterate",
                                           params={'year': year,
                                                   'planningArea': planning_area,
                                                   'token': self.token}).text)
        except Exception as e:
    ...
    def get_marital_statuses(self, year, planning_area, gender=None):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getMaritalStatus",
                                           params={'year': year,
                                                   'planningArea': planning_area,
                                                   'gender': gender,
                                                   'token': self.token}).text)
    ...
    def get_modes_of_transport_to_school(self, year, planning_area):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getModeOfTransportSchool",
                                           params={'year': year,
                                                   'planningArea': planning_area,
                                                   'token': self.token}).text)
        except Exception as e:
    ...
    def get_modes_of_transport_to_work(self, year, planning_area):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getModeOfTransportWork",
                                           params={'year': year,
                                                   'planningArea': planning_area,
                                                   'token': self.token}).text)
        except Exception as e:
    ...
    def get_occupations(self, year, planning_area):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getOccupation",
                                           params={'year': year,
                                                   'planningArea': planning_area,
                                                   'token': self.token}).text)
        except Exception as e:
    ...
    def get_age_groups(self, year, planning_area):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getPopulationAgeGroup",
                                           params={'year': year,
                                                   'planningArea': planning_area,
                                                   'token': self.token}).text)
        except Exception as e:
    ...
    def get_religious_groups(self, year, planning_area):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getReligion",
                                           params={'year': year,
                                                   'planningArea': planning_area,
                                                   'token': self.token}).text)
        except Exception as e:
    ...
    def get_spoken_languages(self, year, planning_area):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getSpokenAtHome",
                                           params={'year': year,
                                                   'planningArea': planning_area,
                                                   'token': self.token}).text)
        except Exception as e:
    ...
    def get_tenancy(self, year, planning_area):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getTenancy",
                                           params={'year': year,
                                                   'planningArea': planning_area,
                                                   'token': self.token}).text)
        except Exception as e:
    ...
    def get_dwelling_types(self, year, planning_area):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getTypeOfDwellingHousehold",
                                           params={'year': year,
                                                   'planningArea': planning_area,
                                                   'token': self.token}).text)
        except Exception as e:
    ...
    def get_population_by_dwelling_types(self, year, planning_area):
        ...
        try:
            return json.loads(request.get(self.url_base + "/privateapi/popapi/getTypeOfDwellingPop",
                                           params={'year': year,
                                                   'planningArea': planning_area,
                                                   'token': self.token}).text)
        except Exception as e:
    ...
    def get_route(self, start_coordinates, end_coordinates, route_type):
        ...
        try:
            ...
            return json.loads(request.get(self.url_base + "/privateapi/routingsvc/route",
    ...
    def generate_static_map(self, layer_chosen, location, zoom, width, height, polygons=None, lines=None, points=None, color=None, fill_color=None):
        ...
        try:
            ...
            if type(location) == tuple or type(location) == list:
                return request.get(self.url_base + "/commonapi/staticmap/getStaticImage",
...
if __name__ == "__main__":
    email = "2101734@sit.singaporetech.edu.sg"
